  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-xl flex items-center justify-center p-4">
      <motion.div
        ...
        className="w-full max-w-lg rounded-3xl bg-[#12121c]/95 border border-white/10 p-6 sm:p-7 shadow-[0_8px_40px_rgba(0,243,255,0.15)] backdrop-blur-2xl"
      >
        {/* Header */}
        ...
        <form onSubmit={handlePublish} className="mt-5 space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 px-4 rounded-2xl font-display text-sm font-bold tracking-wider uppercase bg-gradient-to-tr from-[#00f3ff] to-[#9d00ff] hover:brightness-110 text-black font-extrabold shadow-[0_0_20px_rgba(0,243,255,0.3)] transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-[0.99]"
          >
            {loading ? (
