  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-xl flex items-center justify-center p-0 sm:p-4">
      <motion.div
        ...
        className="w-full h-full sm:h-auto sm:max-h-[90dvh] sm:max-w-lg overflow-y-auto sm:rounded-3xl rounded-none bg-[#12121c]/95 border-0 sm:border sm:border-white/10 p-4 sm:p-6 shadow-[0_8px_40px_rgba(0,243,255,0.15)] backdrop-blur-2xl flex flex-col"
      >
        {/* Header */}
